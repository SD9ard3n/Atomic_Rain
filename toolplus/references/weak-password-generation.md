---
name: weak-password-generation
description: 定位: 替代通用弱口令列表 (admin/123456), 根据目标上下文生成 定制化高命中率 字典 核心: 质量优先 > 数量优先, 1 条精准密码 > 1000 条通用密码 适用: 登录后台 / 管理面板 / SSH / 数据库 / FTP 等需要凭证的入口
